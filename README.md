...
### 최정온
> 애자일 방식으로 개발하려고 했지만 생각한대로 진행되지 않아서 조금은 아쉬웠고 그래도 모두 1인분 이상씩 해주는 팀원분들 덕분에 무사히 프로젝트를 끝마칠 수 있었던거 같아서 기분이 좋습니다.
또한 생각보다 잔버그가 많이 나와서 다음 프로젝트에서는 테스팅과 클린 코드를 구현하기 위해 더욱 더 노력해야겠다고 생각했습니다.
쉬지 않고 열심히 노력해주신 팀원분들 진심으로 감사합니다!! 
